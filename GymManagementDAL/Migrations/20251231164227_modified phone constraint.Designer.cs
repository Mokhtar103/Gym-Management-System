...
namespace GymManagementDAL.Migrations
{
    ...
    [Migration("20251231164227_modified phone constraint")]
    partial class modifiedphoneconstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("Plan_DurationCheck", "DurationInDays Between 1 and 365");
                        });
                });
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("Session_DateCheck", "EndDate > StartDate");
                        });
                });
